...
from antipetros_discordbot.utility.named_tuples import NEW_COMMAND_ITEM
# endregion[Imports]
...
class CommandsListModel(BaseCogPartsModel):
    ...
    def add_command(self):
        ...
        if _ok:
            ...
            if all(name != item.name for item in self.items):
                ...
                self.items.append(self.command_item(name, ''))
